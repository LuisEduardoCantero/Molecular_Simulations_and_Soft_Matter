...
!!
	...
	rmin2=diam/dd+H-2.517d-1*dlt
	rmin3=diam/dd+H+(1.d0-2.517d-1)*dlt
...
!!
	open(1,file='pot1.dat',status='unknown')
	Do i=1,10*nr
		rij=i*0.1d0*dr
		u11=uij(rij,aux)
...
open(10,file='conf_fin.dat', status='unknown')
...
!!		Escalamiento
	...
	enddo
	open(15,file='Fself1.dat',status='unknown')
	qqs=2.0d0*pi*EscR
